package com.servlet.Managers;

import com.servlet.Exceptions.CreateObjectException;
import com.servlet.Exceptions.DoesNotExist;
import com.servlet.Exceptions.MultipleObjectsReturned;
import com.servlet.Exceptions.ParseException;
import com.servlet.Models.BaseModel;
import com.servlet.Models.User;
import com.servlet.Serializers.Serializer;
import com.servlet.Settings.Settings;
...
import com.servlet.ObjectFactory.ObjectFactory;
        ...
        return this.collection.stream().filter(
                obj -> {
                    try {
                        ...
                        if (objectClass.equals(Class.forName("com.servlet.Models.Tweet"))){
                            return TweetManager.matches(obj, config);
                        } else if (objectClass.equals(Class.forName("com.servlet.Models.User"))){
    ...
    public static Boolean matches(Object obj, Map<String, Object> config){
        ...
        try {
            for (String fieldInConfig : config.keySet()) {
                ...
                //-------------------------------------------------------------------
                if (field.getType().equals(Class.forName("com.servlet.Models.User"))){
